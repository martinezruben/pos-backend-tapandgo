        ...
        <div class="space-y-3 px-4 py-3 sm:px-5">
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div class="flex flex-col gap-0.5">
                    <label for="tx-report-from" class="text-[8px] font-bold uppercase tracking-widest text-slate-400">Desde</label>
                    <input
                        id="tx-report-from"
                        type="date"
                        x-model="dateFrom"
                ...
                <div class="flex flex-col gap-0.5">
                    <label for="tx-report-to" class="text-[8px] font-bold uppercase tracking-widest text-slate-400">Hasta</label>
                    <input
                        id="tx-report-to"
                        type="date"
                        x-model="dateTo"
            ...
            <div class="flex flex-col gap-0.5">
                <label for="tx-report-loc" class="text-[8px] font-bold uppercase tracking-widest text-slate-400">Localidad</label>
                <select
                    id="tx-report-loc"
                    x-model="locationId"
                    class="hope-filter-select w-full py-1.5 text-xs"
